...
router.route('/api/books/image/:bookId')
    .put(authCtrl.requireSignin, authCtrl.hasAuthorizationForBook, imgCtrl.UploadImageToMemory, imgCtrl.UploadBookImageToImagekit, bookCtrl.updateImage) // Update with PUT
