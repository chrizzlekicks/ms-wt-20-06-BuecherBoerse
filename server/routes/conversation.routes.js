...
router.route('/api/messages/unread/:convId')
    .get(authCtrl.hasAuthorizationForConversation, conversationCtrl.countUnreadMessages)
...
router.route('/api/messages/:convId')
    ...
    .delete(authCtrl.hasAuthorizationForConversation, conversationCtrl.deleteConvByID)
